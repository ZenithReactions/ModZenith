...
public class block_c4yellow extends Block
{

	public block_c4yellow(int par, int index) 
	{
		super(par, index, Material.clay);
		super.setResistance(2.0F);
		super.setHardness(0.5F);
		super.setStepSound(soundStoneFootstep);
		super.setBlockName("blockYellowC4");
		super.setCreativeTab(CreativeTabs.tabBlock);
		LanguageRegistry.addName(this, "Yellow C4 Block");
	}
