...
public class block_c4green extends Block
{
    ...
    {
        return par1 == 1 ? this.blockIndexInTexture + 3 : (par1 == 0 ? this.blockIndexInTexture + 3 : (par1 == 3 ? this.blockIndexInTexture + 3 : this.blockIndexInTexture));
    }
