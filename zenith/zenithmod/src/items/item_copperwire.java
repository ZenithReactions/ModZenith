...
public class item_copperwire extends Item
{

	public item_copperwire(int par, int index) 
	{
		super(par);
		super.setFull3D();
		super.setItemName("copperwire");
		super.setCreativeTab(CreativeTabs.tabMaterials);
		super.setMaxStackSize(64);
		super.setIconIndex(index);
		LanguageRegistry.addName(this, "Copper Wire");
	}
